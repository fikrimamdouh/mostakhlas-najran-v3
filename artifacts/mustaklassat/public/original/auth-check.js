...
(function () {
  ...
  if (/consumables\.html$/.test(pageFile)) {   appendScript('/original/signature-block.js?v=20260707_v1_consumables_style_cloud_sync', false);   appendScript('/original/consumables-submit-snapshot-guard.js?v=20260704_consumables_guard_v4', true); }
