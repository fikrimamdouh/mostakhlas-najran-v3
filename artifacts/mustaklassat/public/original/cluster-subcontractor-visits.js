(function () {
  ...
  function renderDirectReadiness() {
    ...
    var residenceCheck = representative && representative.noResidenceException ? { ok: !!representative.exceptionReason, text: representative.exceptionReason ? 'استثناء الإقامة مسجل' : 'سبب الاستثناء غير مكتمل' } : null;
    var checks = [
    ...
    if (residenceCheck) checks.push(residenceCheck);
  ...
  function directSelection() {
    ...
    return { maintenanceContractorKey: form.elements.maintenanceContractorKey.value, siteName: form.elements.siteName.value, systemId: form.elements.systemId.value, contractorId: form.elements.contractorId.value, representativeId: form.elements.representativeId.value, startsAt: form.elements.startsAt.value };
  }
  ...
  document.getElementById('direct-form').addEventListener('submit', async function (event) {
    ...
    var body = formObject(this); body.systemId = Number(body.systemId); body.contractorId = Number(body.contractorId); body.representativeId = Number(body.representativeId); body.startsAt = startDay; body.endsAt = null;
