...
(function () {
  ...
  var PREVIEW_PRINT_STYLE = [
    ...
    '@media print{',
      ...
      '.rv-print-root{width:100%!important;max-width:none!important;margin:0!important;padding:0!important;background:#fff!important;box-sizing:border-box!important}',
      '.rv-print-root .rv-doc{width:100%!important;max-width:none!important;margin:0!important;border:0!important;box-shadow:none!important;border-radius:0!important;overflow:visible!important;box-sizing:border-box!important}',
      '.rv-print-root .rv-doc-head{position:static!important;top:auto!important;padding:3mm 4mm 2.2mm!important;background:#fff!important;border-bottom:2px solid #123b6d!important;break-inside:avoid!important}',
      '.rv-print-root .rv-doc-head h2{font-size:17pt!important;margin:0 0 1.5mm!important;color:#123b6d!important}',
      '.rv-print-root .rv-doc-head p{font-size:8.8pt!important;line-height:1.35!important;margin:0!important;color:#334155!important}',
      '.rv-print-root .rv-doc-head>b{font-size:8pt!important;padding:1.2mm 2.4mm!important}',
      '.rv-print-root .rv-tabs,.rv-print-root .rv-no-print{display:none!important}',
      '.rv-print-root section{padding:3mm 4mm!important;border-bottom:0!important;break-inside:auto!important;page-break-inside:auto!important}',
      '.rv-print-root section h3{font-size:14pt!important;margin:0 0 2.5mm!important;color:#123b6d!important}',
      '.rv-print-root .rv-main-stats,.rv-print-root .rv-att-mini,.rv-print-root .rv-substats{display:grid!important;grid-template-columns:repeat(4,1fr)!important;gap:2mm!important;margin:1mm 0 2.3mm!important}',
      '.rv-print-root .rv-stat{padding:1.8mm 2mm!important;min-height:0!important;border-radius:4px!important;box-shadow:none!important;break-inside:avoid!important;overflow:visible!important}',
      '.rv-print-root .rv-stat span{font-size:7.3pt!important;white-space:nowrap!important}',
      '.rv-print-root .rv-stat b{font-size:9.3pt!important;margin-top:.5mm!important;white-space:normal!important;overflow:visible!important}',
      '.rv-print-root .rv-info-grid{display:grid!important;grid-template-columns:repeat(5,1fr)!important;gap:1.6mm!important}',
      '.rv-print-root .rv-info-grid div{padding:1.6mm!important;border-radius:4px!important;overflow:visible!important}',
      '.rv-print-root .rv-info-grid b{font-size:7pt!important}',
      '.rv-print-root .rv-info-grid span{font-size:8.2pt!important;white-space:normal!important}',
      '.rv-print-root .rv-period-note{font-size:8.4pt!important;padding:1.8mm!important;margin:0 0 2.2mm!important;border-radius:4px!important}',
      '.rv-print-root .rv-block{margin:0 0 3mm!important;border:1px solid #cbd5e1!important;border-radius:0!important;box-shadow:none!important;break-inside:auto!important;page-break-inside:auto!important;overflow:visible!important}',
      '.rv-print-root .rv-block-title{padding:1.6mm 2mm!important;break-inside:avoid!important;background:#eef6ff!important}',
      '.rv-print-root .rv-block-title h4{font-size:10.8pt!important}',
      '.rv-print-root .rv-block-title span{font-size:7.8pt!important;padding:.8mm 1.5mm!important}',
      '.rv-print-root .rv-scroll{overflow:visible!important;max-width:none!important;width:100%!important}',
      '.rv-print-root .rv-table{width:100%!important;min-width:0!important;table-layout:auto!important;font-size:6.7pt!important;border-collapse:collapse!important}',
      '.rv-print-root .rv-table th,.rv-print-root .rv-table td{padding:.72mm .42mm!important;white-space:nowrap!important;border:1px solid #cbd5e1!important;line-height:1.18!important}',
      '.rv-print-root .rv-table .nm{white-space:normal!important;min-width:24mm!important;max-width:44mm!important;text-align:right!important;line-height:1.18!important}',
      '.rv-print-root .rv-table .it{white-space:normal!important;text-align:right!important;line-height:1.18!important}',
      '.rv-print-root .rv-day{min-width:3.4mm!important;text-align:center!important}',
      '.rv-print-root #rv-attendance .rv-table{font-size:6.15pt!important}',
      '.rv-print-root #rv-attendance .rv-table th,.rv-print-root #rv-attendance .rv-table td{padding:.62mm .34mm!important}',
      '.rv-print-root #rv-attendance .rv-table .nm{min-width:22mm!important;max-width:38mm!important}',
      '.rv-print-root #rv-performance .rv-table{font-size:7.25pt!important}',
      '.rv-print-root #rv-performance .rv-table .it{min-width:105mm!important;max-width:132mm!important}',
      '.rv-print-root #rv-achievement .rv-table{font-size:8.5pt!important}',
      ...
      '.rv-print-root #rv-performance .rv-block{break-inside:auto!important;page-break-inside:auto!important}',
      '.rv-print-root #rv-performance .rv-substats{grid-template-columns:repeat(4,1fr)!important}',
      '.rv-print-root #rv-performance .rv-block{margin-bottom:2.4mm!important}',
      '.rv-print-root #rv-performance .rv-block-title{padding:1.3mm 2mm!important}',
      '.rv-print-root #rv-performance .rv-table th,.rv-print-root #rv-performance .rv-table td{padding:.7mm .55mm!important}',
      '.rv-print-root #rv-performance .rv-block{display:block!important}',
      '.rv-print-meta{display:block!important;position:fixed;bottom:1.5mm;left:5mm;right:5mm;font-size:7.2pt;color:#475569;border-top:1px solid #cbd5e1;padding-top:1mm;text-align:center;background:#fff!important}',
    '}'
  ].join('');
