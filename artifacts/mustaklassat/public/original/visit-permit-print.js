(function () {
  ...
  if (/request-visit\.html/i.test(pageUrl)) {
    loadScript('/original/request-visit-postponement-mode.js?v=20260716_hospital_postponement_v2');
  }
  if (/cluster-subcontractor-visits\.html/i.test(pageUrl)) {
    loadScript('/original/visit-center-public-kiosk.js?v=20260716_public_kiosk_v2');
  }
})();
