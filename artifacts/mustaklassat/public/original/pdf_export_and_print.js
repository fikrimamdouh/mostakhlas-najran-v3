...
function preparePrint() {
    ...
    <body>
        ...
        <div class="extract-details">
            <p class="extract-details-text">مستخلص العمالة — دفعة رقم <span>${document.getElementById('extract-payment-number')?.textContent || '—'}</span> — شهر <span>${document.getElementById('extract-month')?.textContent || 'غير محدد'}</span> <span>${document.getElementById('extract-year')?.textContent || 'غير محدد'}</span> من تاريخ <span>${document.getElementById('extract-start')?.textContent || 'غير محدد'}</span> إلى <span>${document.getElementById('extract-end')?.textContent || 'غير محدد'}</span></p>
        </div>
    `;
...
function exportToPDF() {
    ...
    extractDetailsDiv.innerHTML = `
        <p>مستخلص العمالة — دفعة رقم <span>${document.getElementById('extract-payment-number')?.textContent || '—'}</span> — شهر <span>${document.getElementById('extract-month')?.textContent || 'غير محدد'}</span> <span>${document.getElementById('extract-year')?.textContent || 'غير محدد'}</span> من تاريخ <span>${document.getElementById('extract-start')?.textContent || 'غير محدد'}</span> إلى <span>${document.getElementById('extract-end')?.textContent || 'غير محدد'}</span></p>
    `;
