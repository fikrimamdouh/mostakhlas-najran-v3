// ===================================================================
// Admin Offices Attendance Tools — Clean Version
// Scope: admin_offices_attendance.html only
// Keeps existing button and function name: openAdminOfficesBulkAttendanceDialog()
// ===================================================================
(function () {
  'use strict';
  ...
  window.AdminOfficesTools = Object.assign({}, window.AdminOfficesTools || {}, {
    installPaymentNumberDisplay,
    openAdminOfficesBulkAttendanceDialog: openCleanBulkAttendanceDialog,
    renderBulkEmployeeList: renderBulkEmployees,
    applyBulkAttendance: applyBulkAttendanceClean,
    selectAllBulkEmployees: selectVisibleEmployees
  });
  ...
  console.info('[Admin Offices Tools] clean bulk attendance installed');
})();
