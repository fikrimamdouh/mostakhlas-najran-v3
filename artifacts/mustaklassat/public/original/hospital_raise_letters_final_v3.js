(function(){
  ...
  loadScript('hospital-raise-letters-engine-v8', '/original/hospital_raise_letters_engine_v8.js?v=20260702_final_amount_absences_saudi_names_v9');
  setTimeout(function(){
  ...
  setTimeout(function(){
    loadScript('hospital-raise-letters-status-pages-fix-v1', '/original/hospital_raise_letters_status_pages_fix_v1.js?v=20260702_v6_absences_saudi_names');
  }, 760);
