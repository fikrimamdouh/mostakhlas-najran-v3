...
(function () {
  ...
  function performancePage(key) {
    ...
    const dedPct = performanceDeductionPercentage(pct);
    const centerCost = totals(key).monthly;
    const dedAmount = centerCost * dedPct / 100;
