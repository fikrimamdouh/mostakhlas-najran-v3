// ===================================================================
// Admin Offices Lightweight Consolidated Print Flow — V7
// - نافذة طباعة مستقلة لا تعتمد على openDialog.
// - الحضور: يستنسخ جدول الصفحة الأصلي مع تحويل select/input إلى نص قبل الطباعة.
// - التقييم: نفس تنسيق المراكز الصحية مع بنود المكتب الفعلية.
// ===================================================================
(function () {
  'use strict';
  if (!/admin_offices_attendance\.html(?:$|[?#])/.test(location.pathname + location.search)) return;
  if (window.__ADMIN_OFFICES_PRINT_ALL_LIGHT_V7__) return;
  window.__ADMIN_OFFICES_PRINT_ALL_LIGHT_V7__ = true;
  ...
  console.info('[Admin Offices Print All] lightweight v7 restored attendance values + health-style performance');
})();