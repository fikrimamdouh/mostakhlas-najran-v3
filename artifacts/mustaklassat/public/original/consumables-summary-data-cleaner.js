...
// Also loads hospital consumables raise letter helper for normal hospital consumables only.
(function () {
  'use strict';
  ...
  function loadHospitalConsumablesRaiseLetter() {
    try {
      ...
      s.src = '/original/hospital_consumables_raise_letter.js?v=20260701_v3';
      s.defer = false;
