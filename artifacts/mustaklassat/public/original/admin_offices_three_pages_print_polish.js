...
(function () {
  ...
  function polishCss() {
    return `<style id="admin-offices-three-pages-print-polish-css">
      ...
      @page admin-office-performance-portrait-polish{size:A4 portrait;margin:5mm!important}
      ...
      /* Performance page: main fix */
      .site-performance-page,.portrait-page-perf{page:admin-office-performance-portrait-polish!important;background:#fff!important;overflow:hidden!important}
      .site-performance,.portrait-page-perf .performance-report,.auto-site-performance-report{height:286mm!important;max-height:286mm!important;min-height:0!important;margin:0!important;padding:0!important;display:flex!important;flex-direction:column!important;overflow:hidden!important;break-inside:avoid!important;page-break-inside:avoid!important;background:#fff!important}
      .site-performance .mini-header,.portrait-page-perf .header-table,.auto-site-performance-report .header-table{flex:0 0 auto!important;margin:0 0 2mm!important;padding:0 0 1.5mm!important;border-bottom:2px solid #003087!important}
      .site-performance .mini-header img,.portrait-page-perf .header-table .logo,.auto-site-performance-report .header-table .logo{width:44px!important;height:44px!important;object-fit:contain!important}
      .site-performance .mini-header h1,.portrait-page-perf .header-table h1,.auto-site-performance-report .header-table h1{font-size:9.5pt!important;line-height:1.1!important;margin:0!important;color:#111827!important}
      .site-performance .mini-header h2,.portrait-page-perf .cert-title,.auto-site-performance-report .cert-title{font-size:13pt!important;line-height:1.15!important;margin:1mm 0!important;color:#003087!important;font-weight:900!important;text-align:center!important}
      .site-performance .mini-header h3,.portrait-page-perf .sub-title,.auto-site-performance-report .sub-title,.perf-subtitle{font-size:8.2pt!important;line-height:1.15!important;margin:0 0 1mm!important;text-align:center!important;color:#334155!important;font-weight:800!important}
      .perf-cost,.portrait-page-perf .cost-bar,.auto-site-performance-report .cost-bar{flex:0 0 auto!important;background:#eef6ff!important;border:1px solid #bfdbfe!important;border-radius:7px!important;text-align:center!important;font-size:8pt!important;font-weight:900!important;color:#0f172a!important;padding:1.4mm!important;margin:0 0 1.5mm!important;line-height:1.15!important}
      .performance-table,.portrait-page-perf table,.auto-site-performance-report table{width:100%!important;border-collapse:collapse!important;table-layout:fixed!important;margin:0!important;font-size:7pt!important;flex:1 1 auto!important;background:#fff!important}
      ...
      .performance-table th,.performance-table td,.portrait-page-perf th,.portrait-page-perf td,.auto-site-performance-report th,.auto-site-performance-report td{border:1px solid #1f2937!important;padding:1.65mm 1.2mm!important;line-height:1.18!important;text-align:center!important;vertical-align:middle!important}
      .performance-table th,.portrait-page-perf th,.auto-site-performance-report th{background:#003087!important;color:#fff!important;font-weight:900!important;font-size:7.4pt!important}
      .performance-table th:nth-child(1),.performance-table td:nth-child(1),.portrait-page-perf th:nth-child(1),.portrait-page-perf td:nth-child(1){width:7%!important}
      .performance-table th:nth-child(2),.performance-table td:nth-child(2),.portrait-page-perf th:nth-child(2),.portrait-page-perf td:nth-child(2),.performance-table .item-text,.portrait-page-perf .item-text{width:67%!important;text-align:right!important;white-space:normal!important;overflow-wrap:anywhere!important;font-weight:800!important}
      .performance-table th:nth-child(3),.performance-table td:nth-child(3),.performance-table th:nth-child(4),.performance-table td:nth-child(4),.portrait-page-perf th:nth-child(3),.portrait-page-perf td:nth-child(3),.portrait-page-perf th:nth-child(4),.portrait-page-perf td:nth-child(4){width:13%!important;font-weight:900!important}
      ...
      .performance-table .perf-total td,.portrait-page-perf .perf-total td,.auto-site-performance-report .perf-total td{background:#dbeafe!important;color:#0f172a!important;font-weight:900!important;font-size:8pt!important}
      .perf-summary,.portrait-page-perf .summary,.auto-site-performance-report .summary{flex:0 0 auto!important;background:#fefce8!important;border:1px solid #d4af37!important;border-radius:8px!important;padding:1.6mm!important;margin:1.2mm 0!important;text-align:center!important;font-size:8pt!important;line-height:1.25!important;font-weight:900!important;color:#111827!important}
      .performance-signatures,.portrait-page-perf .signatures,.auto-site-performance-report .signatures{flex:0 0 auto!important;margin-top:auto!important;padding-top:2.5mm!important;border-top:1.5px solid #111!important;display:flex!important;justify-content:space-around!important;gap:8mm!important}
      .performance-signatures .sign-item,.portrait-page-perf .sign-box,.auto-site-performance-report .sign-box{width:30%!important;text-align:center!important;font-size:8pt!important;font-weight:900!important;color:#111827!important}
      .performance-signatures .sig-line,.portrait-page-perf .line,.portrait-page-perf .sign-box .line,.auto-site-performance-report .line{height:11mm!important;border-bottom:1px solid #111!important;margin:1.5mm 7mm!important}
  ...
  console.info('[Admin Offices Three Pages Print Polish] installed v1 attendance/performance/achievement');
})();
