...
(function () {
  ...
  function polishCss() {
    return `<style id="admin-offices-three-pages-print-polish-css">
      ...
      @page admin-office-performance-achievement-like{size:A4 portrait;margin:7mm!important}
      ...
      /* Performance page: compact table like the final achievement page, with signature space below */
      .site-performance-page,.portrait-page-perf{page:admin-office-performance-achievement-like!important;background:#fff!important;overflow:visible!important}
      .site-performance,.portrait-page-perf .performance-report,.auto-site-performance-report{min-height:284mm!important;margin:0!important;padding:0 8mm 7mm!important;display:block!important;overflow:visible!important;background:#fff!important;break-inside:avoid!important;page-break-inside:avoid!important;height:auto!important;max-height:none!important}
      .site-performance .mini-header,.portrait-page-perf .header-table,.auto-site-performance-report .header-table{width:100%!important;margin:0 0 4mm!important;padding:0 0 2mm!important;border-bottom:2px solid #003087!important}
      .site-performance .mini-header img,.portrait-page-perf .header-table .logo,.auto-site-performance-report .header-table .logo{width:54px!important;height:54px!important;object-fit:contain!important}
      .site-performance .mini-header h1,.site-performance .mini-header h2,.site-performance .mini-header h3,.portrait-page-perf .header-table .title-box h1,.portrait-page-perf .header-table .title-box h2,.auto-site-performance-report .header-table .title-box h1,.auto-site-performance-report .header-table .title-box h2{margin:2px 0!important;line-height:1.2!important;text-align:center!important;color:#111827!important}
      .site-performance .mini-header h1,.portrait-page-perf .header-table .title-box h1,.auto-site-performance-report .header-table .title-box h1{font-size:10pt!important;font-weight:900!important}
      .site-performance .mini-header h2,.site-performance .mini-header h3,.portrait-page-perf .header-table .title-box h2,.auto-site-performance-report .header-table .title-box h2{font-size:10pt!important;font-weight:800!important}
      .performance-report .cert-title,.site-performance .mini-header h2,.portrait-page-perf .cert-title,.auto-site-performance-report .cert-title{font-size:17pt!important;font-weight:900!important;text-align:center!important;margin:2mm 0 1mm!important;color:#003087!important;line-height:1.25!important}
      .performance-report .sub-title,.portrait-page-perf .sub-title,.auto-site-performance-report .sub-title,.perf-subtitle{font-size:11pt!important;text-align:center!important;margin:1mm 0 2mm!important;color:#111827!important;line-height:1.25!important;font-weight:900!important}
      .performance-report .cost-bar,.portrait-page-perf .cost-bar,.auto-site-performance-report .cost-bar,.perf-cost{background:#f8fafc!important;border:1px solid #cbd5e1!important;border-radius:4px!important;text-align:center!important;font-size:9.5pt!important;font-weight:900!important;margin:0 0 3mm!important;padding:4px!important;color:#111827!important;line-height:1.25!important}
      .performance-report table,.performance-table,.portrait-page-perf table,.auto-site-performance-report table{width:100%!important;border-collapse:collapse!important;table-layout:fixed!important;font-size:8.3pt!important;margin:0!important;background:#fff!important;height:auto!important;min-height:0!important;max-height:none!important}
      .performance-report thead,.performance-table thead,.portrait-page-perf thead,.auto-site-performance-report thead{display:table-header-group!important}
      .performance-report tr,.performance-table tr,.portrait-page-perf tr,.auto-site-performance-report tr{height:auto!important;min-height:0!important;break-inside:avoid!important;page-break-inside:avoid!important}
      .performance-report th,.performance-report td,.performance-table th,.performance-table td,.portrait-page-perf th,.portrait-page-perf td,.auto-site-performance-report th,.auto-site-performance-report td{border:1px solid #111!important;padding:2.2px 4px!important;text-align:center!important;vertical-align:middle!important;line-height:1.22!important;color:#111!important;height:auto!important;min-height:0!important}
      .performance-report th,.performance-table th,.portrait-page-perf th,.auto-site-performance-report th{background:#e5e7eb!important;color:#111!important;font-weight:900!important;font-size:8.6pt!important}
      .performance-report .item-text,.performance-table .item-text,.portrait-page-perf .item-text,.auto-site-performance-report .item-text{text-align:right!important;white-space:normal!important;overflow-wrap:anywhere!important;line-height:1.22!important;font-size:8.3pt!important;font-weight:700!important}
      ...
      .performance-report tbody tr:nth-child(even) td,.performance-table tbody tr:nth-child(even) td,.portrait-page-perf tbody tr:nth-child(even) td,.auto-site-performance-report tbody tr:nth-child(even) td{background:#fff!important}
      .performance-report .perf-total td,.performance-table .perf-total td,.portrait-page-perf .perf-total td,.auto-site-performance-report .perf-total td,.performance-report tbody tr:last-child td,.performance-table tbody tr:last-child td,.portrait-page-perf tbody tr:last-child td,.auto-site-performance-report tbody tr:last-child td{font-weight:900!important;background:#e5e7eb!important;font-size:8.6pt!important}
      .performance-report .summary,.portrait-page-perf .summary,.auto-site-performance-report .summary,.perf-summary{margin:0!important;font-size:9.2pt!important;line-height:1.35!important;text-align:center!important;background:#f3f4f6!important;border:1px solid #111!important;border-top:0!important;padding:5px!important;color:#111!important;font-weight:900!important}
      .performance-report .summary p,.portrait-page-perf .summary p,.auto-site-performance-report .summary p{margin:0!important}
      .performance-report .signatures,.performance-signatures,.portrait-page-perf .signatures,.auto-site-performance-report .signatures{margin-top:20mm!important;display:flex!important;justify-content:space-around!important;border-top:0!important;padding-top:0!important;gap:8mm!important;break-inside:avoid!important;page-break-inside:avoid!important}
      .performance-report .sign-box,.performance-signatures .sign-item,.portrait-page-perf .sign-box,.auto-site-performance-report .sign-box{width:30%!important;text-align:center!important;font-size:10pt!important;color:#111!important;font-weight:900!important}
      .performance-report .sign-box .title,.performance-signatures .sig-title,.portrait-page-perf .sign-box .title,.auto-site-performance-report .sign-box .title{font-weight:900!important;margin-bottom:5mm!important}
      .performance-report .sign-box .line,.performance-signatures .sig-line,.portrait-page-perf .sign-box .line,.portrait-page-perf .line,.auto-site-performance-report .sign-box .line,.auto-site-performance-report .line{border-bottom:1px solid #000!important;margin:8mm 8mm 2mm!important;height:0!important}
  ...
  console.info('[Admin Offices Three Pages Print Polish] installed v4 performance achievement-like compact table');
})();
