// Hospital Raise Letters Toolbar Clean CSS V2
...
// Keeps the index print button clearly visible.
(function () {
  'use strict';

  if (!/hospital_raise_letters\.html/.test(location.pathname) && !window.__HOSPITAL_LETTERS_STANDALONE_PAGE__) return;
  if (window.__HOSPITAL_RAISE_LETTERS_TOOLBAR_CLEAN_CSS_V2__) return;
  window.__HOSPITAL_RAISE_LETTERS_TOOLBAR_CLEAN_CSS_V2__ = true;

  function ensureCss() {
    if (document.getElementById('hrl-toolbar-clean-css-v2')) return;
    var st = document.createElement('style');
    st.id = 'hrl-toolbar-clean-css-v2';
    st.textContent = [
      ...
      '#hrl .toolbar button[data-print="index"]{order:3!important;flex:1 1 210px!important;background:#003087!important;color:#fff!important;border-color:#003087!important;}',
      '#hrl .toolbar button[data-print="index"]::before{content:"طباعة ";}',
      '#hrl .toolbar button[data-print]:not([data-print="packet"]):not([data-print="selected"]):not([data-print="index"]){order:4!important;flex:1 1 150px!important;background:#ffffff!important;color:#003087!important;border-color:#93c5fd!important;}',
      ...
      '@media(max-width:820px){#hrl .toolbar .btn,#hrl .toolbar .doc-select{flex:1 1 145px!important;min-width:0!important;}#hrl .toolbar button[data-print="index"]{flex:1 1 100%!important;}}'
    ].join('');
  ...
  console.info('[Hospital Raise Letters Toolbar Clean CSS] installed v2 index prominent');
})();