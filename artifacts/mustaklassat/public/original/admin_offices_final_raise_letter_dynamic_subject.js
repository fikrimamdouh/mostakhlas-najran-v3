...
function grandNet() {
  const ready = readReadyFinalNet();
  if (ready > 0) return ready;

  return centerKeys().reduce((s, k) => s + num(calcSite(k).finalNet), 0);
}
