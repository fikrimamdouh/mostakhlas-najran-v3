...
const COMPANY_SITES = {
  "تجمع_نجران": {
    ...
    sites: [
      ...
      { name: "مستشفى نجران العام القديم",                                  contract: "" },
      { name: "مستشفى الولادة والأطفال",                                    contract: "" },
      ...
      { name: "المراكز الصحية (مجمع)",                                      contract: "" },
      { name: "المكاتب الإدارية والمرافق الصحية",                          contract: "" },
    ],
  },
  "بيت_العرب": {
