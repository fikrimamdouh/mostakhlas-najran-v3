...
import visitCatalogRouter from "./visit-catalog";
import visitManagementRouter from "./visit-management";
...
router.use("/visits/catalog", visitCatalogRouter);
router.use("/visits/manager", visitManagementRouter);
