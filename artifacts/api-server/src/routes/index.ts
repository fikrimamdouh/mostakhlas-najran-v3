...
import usersProfileEditRouter from "./users-profile-edit";
...
import submittedExtractsLiteRouter from "./submitted-extracts-lite";
...
import visitsSchemaGuardRouter from "./visits-schema-guard";
import visitsPublicFormRouter from "./visits-public-form";
import visitsRequestSafetyRouter from "./visits-request-safety";
import visitsPublicKioskRouter from "./visits-public-kiosk";
import visitsIncomingWorkflowRouter from "./visits-incoming-workflow";
import visitsCentralApprovalRouter from "./visits-central-approval";
import visitsDirectSetupHotfixRouter from "./visits-direct-setup-hotfix";
import visitsFireCompanyCatalogRouter from "./visits-fire-company-catalog";
...
router.use("/submitted-extracts-lite", submittedExtractsLiteRouter);
...
router.use("/visits", visitsSchemaGuardRouter);
router.use("/visits", visitsPublicFormRouter);
router.use("/visits", visitsRequestSafetyRouter);
router.use("/visits", visitsPublicKioskRouter);
router.use("/visits", visitsIncomingWorkflowRouter);
router.use("/visits", visitsCentralApprovalRouter);
router.use("/visits", visitsDirectSetupHotfixRouter);
router.use("/visits", visitsFireCompanyCatalogRouter);
