...
- رسالة Clerk عن development keys تعني أن التطبيق يعمل بمفتاح `pk_test`. هذا مقبول محليًا فقط؛ في Vercel/production يجب ضبط `VITE_CLERK_PUBLISHABLE_KEY` أو `NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY` على مفتاح `pk_live`.
